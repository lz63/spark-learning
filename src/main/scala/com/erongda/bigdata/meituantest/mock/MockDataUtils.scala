package com.erongda.bigdata.meituantest.mock
...
object MockDataUtils {
  ...
  val LOCAL_TRACK_DATAS_DIRC = "file:///E:/IDEAworkspace/spark-learning/datas/track/"
  ...
  def loadUserVisitActionMockData(spark: SparkSession): Unit ={
    ...
    spark.read.table("db_track.visit_action").show(10, truncate = false)

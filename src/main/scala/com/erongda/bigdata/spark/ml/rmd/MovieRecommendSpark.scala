...
object MovieRecommendSpark {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // TODO: 1. 构建SparkSession实例对象,因为SparkSession有read方法可以读取不同格式的文件直接返回DataFrame
    ...
    */
    ...
    // TODO： 模型保存
    mlAlsModel.write.overwrite()save(ContantUtils.LOCAL_DATA_DIC + "/als/mlAlsModel")

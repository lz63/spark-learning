...
import com.erongda.bigdata.utils.{ConstantUtils, RandomUtils}
...
/**
  ...
  * 订单金额
  */
case class Order(orderId: String, provinceId: Int, orderPrice: Double)
  ...
  def main(args: Array[String]): Unit = {
    ...
    try {
      ...
      while (true) {
        ...
        // 每次循环 模拟产生的订单数目
        val randomNumber = RandomUtils.getRandomNum(10) + 5
        // TODO: startTime
        ...
        // 线程休眠
        Thread.sleep(RandomUtils.getRandomNum(10) * 10 + 10)
      }
